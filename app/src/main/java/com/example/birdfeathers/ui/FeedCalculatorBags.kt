...
fun FeedCostCalculatorBags(
    ...
    var bagSize by remember { mutableStateOf(50) } // default to 50kg

    val bags = (totalFeed / bagSize).toInt()
    val remainder = totalFeed - (bags * bagSize)

    val starterBags = (starterTotal / bagSize).toInt()
    val starterRem = starterTotal - (starterBags * bagSize)

    val growerBags = (growerTotal / bagSize).toInt()
    val growerRem = growerTotal - (growerBags * bagSize)

    val finisherBags = (finisherTotal / bagSize).toInt()
    val finisherRem = finisherTotal - (finisherBags * bagSize)
            ...
            Column(
...

                {
                    ...
                    )
                    {
                        ...
                        Text(
                            "Starter: $starterBags bags + ${"%.2f".format(starterRem)} kg",
                            style = MaterialTheme.typography.bodyLarge,
...

                {
                    ...
                    )
                    {
                        ...
                        Text(
                            "Grower: $growerBags bags + ${"%.2f".format(growerRem)} kg",
                            style = MaterialTheme.typography.bodyLarge,
...

                {
                    ...
                    )
                    {
                        ...
                        Text(
                            "Finisher: $finisherBags bags + ${"%.2f".format(finisherRem)} kg",
                            style = MaterialTheme.typography.bodyLarge,
                ...
                Column(
                    ...
                    Text(
                        "Total Feed: $bags bags (${bagSize}kg each) + ${"%.2f".format(remainder)} kg",
                        style = MaterialTheme.typography.titleMedium,
                        color = Color(0xFF1976D2), // Brighter blue for visibility
